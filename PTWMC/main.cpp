...
int main(int argc,char** argv)
{
    ...
    */
    ...
    // 从命令行参数获取文件路径和更新模式
    char* fpath = argv[1];              // 图数据文件路径
    const char* updateMode = argv[2];   // "add" / "delete" / "none"
    const char* edgeUpdatePath = argv[3]; // 边更新数据文件路径
    ...
    */
    //fpath = "D:\\school\\second year\\First Semester\\biclique index\\datasets\\cit-Patents.txt";//amazon0601 //email-Enron  youtube
    t = 'A';
    max_k = 0;
    flag_d = 0;
